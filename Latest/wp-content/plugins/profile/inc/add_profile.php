...
include( plugin_dir_path( __FILE__ ) . 'include_add.php'); ?>
      ...
      <ul>
        ...
        <li id="profile_affiliated">
          ...
          <div class="has-btn">
            ...
            <input id="affiliated" name="affiliated[]" class="element text medium" type="text" value="<?php echo $_POST['affiliated'][0]; ?>"/>
