...
require get_template_directory() . '/page-templates/inc/include_addprofile.php';
?>
        ...
        <form id="CompProfileForm" class="custom" enctype="multipart/form-data" method="post" action="<?php echo get_permalink( 20 ); ?>">
          ...
          <div id="profile_affiliated">
            ...
            <div class="has-btn">
              ...
              <input type="text" name="affiliated[]" id="affiliated" value="<?php echo $_POST['affiliated'][0]; ?>">
            </div>
          </div>
