...
get_header();
require get_template_directory() . '/page-templates/inc/include_detailprofile.php';
...
<div class="row" id="contentSection">
  <div class="profile-sec">
    <div class="large-6 columns pad-no text-right"> 
	<!--<a href="#" class="share-btn" title=""><img src="<?php bloginfo('template_directory'); ?>/img/share-icon.jpg" alt="image"/></a>-->
      ...
      <div class="large-5 large-offset-1 columns"> 
        ...
        <div class="hide-for-large-only">
          ...
          <ul class="accordion" data-accordion="myAccordionGroup">
            <li class="accordion-navigation"> <a href="#panelFollow" aria-expanded="false" title="">Follow Company / Project<i class="fa fa-caret-right up"></i></a>
    ...
    <div id="appendsimilar" class="similar_profiles_area">
    <?php 
      $i=1;
    ...
    <div class="large-5 columns prof-col">
      <div class="panel">
        ...
        <div class="row prof-cont">
          ...
          <div class="small-9 columns"> <a href="<?php echo get_profileUrl($getSimilarProfile->id); ?>" class="comp-name" title=""><?php echo $getSimilarProfile->name; ?></a>
